	...
	<div className="container">
		...
		<div className="details">
			<div className="detail">
				<figure>
					<Img fluid={data.fruit.childImageSharp.fluid} alt="フルーツ" />
				</figure>
				<h3>フルーツ</h3>
				<p>FRUIT</p>
			...
			<div className="detail">
				<figure>
					<Img fluid={data.grain.childImageSharp.fluid} alt="穀物" />
				</figure>
				<h3>穀物</h3>
				<p>GRAIN</p>
			...
			<div className="detail">
				<figure>
					<Img fluid={data.beverage.childImageSharp.fluid} alt="飲み物" />
				</figure>
				<h3>飲み物</h3>
				<p>BEVERAGE</p>
